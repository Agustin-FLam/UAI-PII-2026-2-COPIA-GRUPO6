...
/*
 ...
 e. Mostrar Listado de las personas
 */
namespace tp04_listas03
{
    ...
    public class ListaEnlazadaSimple
    {
        ...
        // Recorrido recursivo para el próximo código disponible (mismo patrón que BuscarMaximo).
        ...
        // d. Agregar después del seleccionado
        public void AgregarDespuesDe(int codigoSeleccionado, int edadNueva)
        {
            NodoSimple seleccionado = BuscarNodo(NodoInicial, codigoSeleccionado);
            if (seleccionado == null)
            {
                Console.WriteLine("No se encontró la persona seleccionada.");
                return;
            }

            NodoSimple nuevo = new NodoSimple();
            nuevo.Codigo = ProximoCodigo();
            nuevo.Edad = edadNueva;
            nuevo.PrecioEntrada = CalcularPrecio(edadNueva);
